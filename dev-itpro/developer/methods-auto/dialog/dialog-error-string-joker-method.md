...
The window is automatically sized to hold the longest line of text and total number of lines. Calling the method with and **empty** string will end the execution of AL code without displaying a message.
